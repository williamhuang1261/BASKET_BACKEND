...
/**
 * Validates user items update request body
 * @param {object} body - Request body
 * @param {Array<{id: string, select: {method: string, units: string, quantity: number}}>} body.items - Items to update
 * @param {string} body.items[].id - Item ID
 * @param {object} body.items[].select - New selection details
 ...
 */
const userItemsPutVal = (body:any) => {
...
export default userItemsPutVal